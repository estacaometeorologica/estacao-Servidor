...
INSERT INTO `estacao` (`idEstacao`, `apiKey`, `nome`, `idUsuario`) VALUES
(1, NULL, 'EstacaoTeste', 1);
...
INSERT INTO `leitor` (`idLeitor`, `ativo`, `idEstacao`, `idSensor`) VALUES
(1, 1, 1, 1),
(2, 1, 1, 2),
(3, 1, 1, 3);
...
INSERT INTO `sensor` (`idSensor`, `grandeza`, `unidade`) VALUES
(1, 'Temperatura', 'graus Celsius'),
(2, 'Humidade Relativa do Ar', '%'),
(3, 'Pressão Atmosférica', 'hPa');
...
INSERT INTO `usuario` (`idUsuario`, `apiKey`, `login`, `senha`, `nome`, `sobrenome`, `cpf`, `telefone`, `email`, `endereco`, `instituicao`, `admin`, `ativo`) VALUES
(1, NULL, 'regis', 'ÿÊ†7H4tØ', 'Régis', 'Martiny', 2230958003, NULL, 'regismartiny@gmail.com', NULL, NULL, 1, 1);
